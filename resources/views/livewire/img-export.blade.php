...
<body style="margin: 0; padding: 0; font-family: 'Poppins', Arial, sans-serif; background-color: #f5f7fa; display: flex; justify-content: center; align-items: center; min-height: 100vh;">
    <div style="width: 100%; max-width: 800px; margin: 20px; background: linear-gradient(135deg, #ffffff 0%, #f0f8ff 100%); border-radius: 15px; box-shadow: 0 10px 30px rgba(0, 0, 102, 0.1); overflow: hidden;">
        ...
        <!-- Header -->
        {{-- <div style="background: linear-gradient(135deg, #0046ad 0%, #0073e6 100%); padding: 25px; text-align: center; color: white;">
        ...
        <div style="padding: 30px 40px; position: relative;">
            ...
            src="{{ asset('images/logo.jpeg') }}" alt="Cherry Lann Logo"
